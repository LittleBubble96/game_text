...
namespace GameLogic
{
    [Window(UILayer.UI,location:"UISetting")]
    class UISetting : UIWindow
    {
        ...
        private string _showAnim = "Ui_SettingShow";
        private string _hideAnim = "Ui_SettingHide";
        private Animation _animation;

        private XYButton _closeBtn;
        private XYButton _bgCloseBtn;
        ...
        protected override void OnCreate()
        {
            ...
            _bgCloseBtn.OnAddListener(Hide);
